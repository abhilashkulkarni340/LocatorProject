...
Tracer gps;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gps = new Tracer(MapsActivity.this);
...
//gps.showSettingAlert();
        ...
        String near;
        Intent i=getIntent();
        destination=i.getStringExtra("destination_address_key");
        destination_name=destination+","+i.getStringExtra("destination_name_key");
        sendRequest();
